...
const connectedSources = [
  ...
  {
    name: "국토교통부 VWorld 도시계획 공간정보(지구단위계획)",
    purpose:
      "서울·경기·인천의 도시개발·택지개발 관련 지구단위계획 경계 확인(법정 정비구역으로 사용하지 않음)",
    link: "https://www.vworld.kr/",
  },
  {
    name: "국토교통부 VWorld 산업단지 공간정보",
    purpose:
      "현재 지도 영역의 국가·일반·도시첨단·농공 산업단지 경계와 단지명 확인",
    link: "https://www.vworld.kr/",
  },
  {
    name: "국토교통부 VWorld 도시계획시설 공간정보",
    purpose:
      "현재 지도 영역의 미집행·부분집행 간선도로(대로), 철도계획시설, 교통광장·IC 관련 계획 경계 확인",
    link: "https://www.vworld.kr/",
  },
  {
    name: "VWorld 도시및주거환경정비 정비구역(UD602)",
    purpose:
      "경기도 도시정비법상 지정·고시 구역 353건의 법정 경계 확인(준공·입주·청산 사업은 지도에서 제외)",
    link: "https://www.vworld.kr/dtmk/dtmk_ntads_s002.do?svcCde=MK&dsId=30335",
  },
  {
    name: "경기 1기 신도시 노후계획도시 특별정비구역 고시",
    purpose:
      "도시정비법 자료에 포함되지 않는 분당 4·평촌 2·산본 2·중동 1곳의 특별정비구역 경계와 지정일 확인",
    link: "https://www.seongnam.go.kr/pm010301/145352",
  },
  {
...
const officialReferenceSources = [
  {
    name: "VWorld 도시및주거환경정비 정비구역(UD602)",
    purpose: "도시정비법 제16조에 따라 지정·고시된 경기 법정 정비구역 경계 확인",
    link: "https://www.vworld.kr/dtmk/dtmk_ntads_s002.do?svcCde=MK&dsId=30335",
  },
  {
      ...
      <main className="legal-page">
        <article className="container">
          ...
          <ul>
            ...
            <li>
              도시개발·택지개발·산업단지와 미집행·부분집행 간선도로,
              철도계획시설, 교통광장·IC 관련 경계는 현재 지도 영역을 기준으로
              VWorld 공간정보에서 조회하며 최대 10분 캐시됩니다. 이 레이어는
              법정 정비구역 또는 확정 공사 일정으로 해석하지 않습니다.
            </li>
            <li>
              경기 1기 신도시 특별정비구역은 2026년 8월 24일까지 법적 지정을
              확인한 9곳입니다. 경계는 공식 지형도면과 대조한 공개 좌표 또는
              공동주택 주필지 결합 자료이므로 원본 지형도면과 일부 차이가 날 수
              있습니다.
            </li>
            <li>
          ...
          <p>
            땅뷰는 현재 무료·비상업 공개를 전제로 서울플랜+와 VWorld UD602
            공간자료를 지도용으로 변환해 표시합니다. 두 자료는 공공누리 제4유형
            (출처표시·상업적 이용 금지·변경 금지)이므로 서울시와 제공기관에
            지도 표시·좌표 변환 허용 범위를 문의 중입니다. 수익화를 시작할 때는
            별도 허락을 받기 전까지 해당 공간 레이어를 서비스에서 내립니다. 경기
            1기 신도시 특별정비구역은 성남·안양·군포·부천시 및 토지이음 고시와
            지형도면을 출처로 별도 표시합니다.
          </p>
