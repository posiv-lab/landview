...
const connectedSources = [
  ...
  {
    name: "성남시 분당 노후계획도시 특별정비구역 지형도면 고시",
    purpose:
      "도시정비법 자료에 포함되지 않는 분당 선도지구 4곳의 특별정비구역 경계와 지정일 확인",
      ...
      <main className="legal-page">
        <article className="container">
          ...
          <ul>
            ...
            <li>
              도시개발·택지개발 관련 경계는 현재 지도 영역을 기준으로
              VWorld 지구단위계획 공간정보에서 조회하며 최대 10분 캐시됩니다.
              이 레이어는 법정 정비구역으로 해석하지 않습니다.
            </li>
            <li>
          ...
          <p>
            ...
            별도 허락을 받기 전까지 해당 공간 레이어를 서비스에서 내립니다. 분당
            특별정비구역은 성남시·토지이음 고시와 지형도면을 출처로 별도 표시합니다.
          </p>
